    ...
    switch (action.type) {
        ...
        case OPEN_CELL: {
            ...
            const checkAround = (row, cell) => {
                // console.log('작동!', row, cell);
                if (row < 0 || row >= tableData.length || cell < 0 || cell >= tableData[0].length) { //상하좌우 칸이 아닌 경우 필터함
                    return;
                }
        ...
        case FLAG_CELL: {
            console.log('response flag cell!!!')
            const tableData = [...state.tableData];
            tableData[action.row] = [...state.tableData[action.row]];
